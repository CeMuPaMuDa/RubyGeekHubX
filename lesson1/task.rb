...
puts "Результат: " + (arr_mini.index(arr_mini.select { |a| arr_mini[0] < a && a < arr_mini[-1] }.first) || []).to_s
#puts "---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------"
...
puts "Исходный массив: " + arr.to_s + " Число K: " + k_num.to_s
puts "Результат: " + (arr.any? { |e| e < k_num }).to_s
puts "---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------"
...
puts "Исходный массив: " + arr.to_s + " Число K: " + k_num.to_s
puts "Результат: " + (arr.all? { |e| e < k_num }).to_s
puts "---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------"
