...
r_num = rand(-100.00...100.00).round(2)
puts "---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------"
...
puts "Результат: " + (arr.select.with_index { |_, index| index.even? } + arr.select.with_index { |_, index| index.odd? }).to_s
puts "---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------"
puts "2. Дан целочисленный массив. Необходимо вывести вначале его элементы с нечетными индексами, а затем - четными."
puts "Исходный массив: " + arr.to_s
puts "Результат: " + (arr.select.with_index { |_, index| index.odd? } + arr.select.with_index { |_, index| index.even? }).to_s
puts "---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------"
...
puts "Исходный массив: " + arr.to_s
puts "Результат: " +puts '2: ' +arr.map{|m|if m>=0; m = arr.min; else m = m end}.to_s
puts "---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------"
